...
###################################
    ...
    image_name = None  # nombre sin extensiones
    path = None  # ruta de la carpeta 
    image_size = None  # resolucion 
    image_ext = None
    ...
    def setKeyImage(self, key: bytes):
        self.key = pad(key, 16)

    def setIvImage(self, iv: bytes):
        self.iv = pad(iv, 16)

    def setModeImage(self, modo: str):
        if(modo == 'ECB'):
